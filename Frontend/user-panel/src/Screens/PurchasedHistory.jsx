                ...
                {currentItems.map((purchase) => (
                    <Col key={purchase.id} xs={12} sm={6} md={4} lg={3}>
                        <Card className="purchase-card shadow-sm">
                            ...
                            <Card.Img 
                                variant="top" 
                                src={purchase.productImage ? purchase.productImage : "placeholder.jpg"} 
                            ...
                            <Card.Body className="card-body-compact">
                                ...
                                <Card.Text className="quantity small-text">Quantity: {purchase.quantity}</Card.Text>
                                <Card.Text className="price">Total Price: ₹{purchase.totalPrice.toFixed(2)}</Card.Text>
